...
\TG{The text has a few spelling mistakes, grammar errors, and heavy sentences. Could you 
check it all with Grammarly? I highlighted some of them \english{like this} but won't fix them.}
...
Processing and storage of this massive amount of data in those applications 
require large-scale solutions and thus must data-intensive applications be 
executed on large-scale infrastructures such as cloud or High Performance 
...
As a result, there is an increasing demand for performance quantification 
